...
let EventsService = class EventsService extends base_service_1.BaseService {
    ...
    findOne(filter = {}, selectFields = '') {
        return __awaiter(this, void 0, void 0, function* () {
            const eventItem = yield this._model
                .findOne(filter)
    ...
    addEntrant(id, entrant) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._model.findOneAndUpdate({ _id: id }, { $push: { entrants: entrant._id } });
...
EventsService = __decorate([
    common_1.Injectable(),
    __param(0, mongoose_1.InjectModel(event_model_1.EventModel.modelName)),
